            ...
            <div className={styles.containerBar}>
               ...
               <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#f5f3f3">
                  ...
                  <g id="SVGRepo_iconCarrier"> 
                     ...
                     <path fillRule="evenodd" clipRule="evenodd" d="M7 13c1.296 0 2.496-.41 3.476-1.11l2.817 2.817a1 1 0 001.414-1.414l-2.816-2.816A6 6 0 107 13zm0-2a4 4 0 100-8 4 4 0 000 8z"></path> 
                  </g>
               </svg>
               </button>
            </div>
